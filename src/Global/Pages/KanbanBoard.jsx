...
import { users, backlogTasks, filterOptions, attendanceOptions, roleOptions, priorityOptions, statusOptions, sections, sectionTitles } from "../Utils/mockData";
...
function KanbanBoard() {
  ...
  const { timers, handleStart, handlePause, handleResume, handleEnd, parseTimeToSeconds, formatSecondsToTime, pauseAllOtherTasks } = useTimers();
