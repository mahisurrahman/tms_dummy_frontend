...
const CreateUserForm = ({ onClose, onCreateUser, loading }) => {
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div>
            ...
            <input
              type="text"
              name="designation"
              placeholder="Junior Software Engineer I"
